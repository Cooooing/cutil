...
replace (
	...
	github.com/Cooooing/cutil/sql => ./sql
	github.com/Cooooing/cutil/stream => ./stream
)

require (
	github.com/Cooooing/cutil/common v0.0.0-20250825024611-76e9bd7621a7
	github.com/Cooooing/cutil/excel v0.0.0-20250825024611-76e9bd7621a7
	github.com/Cooooing/cutil/sql v0.0.0-20250825024611-76e9bd7621a7
